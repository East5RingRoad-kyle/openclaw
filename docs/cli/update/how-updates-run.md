...
records the phase, elapsed time, and bounded diagnostics; the test Gateway process group
and temporary state are cleaned up. This proves the new version’s core startup on copied
